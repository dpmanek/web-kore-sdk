(function (KoreSDK) {
	...
	botOptions.userIdentity = '64dba3330009bd395894ed82'; // Provide users email id here //email id changed form mphasis to private
	botOptions.botInfo = {
		name: 'BankingBotDemo',
		_id: 'st-5abd6d05-18d2-5895-b9de-78338020d9cb',
    ...
    **/
	botOptions.clientId = 'cs-3b898e30-2746-5423-ba9d-473d6db182e8';
	botOptions.clientSecret = 'nvtIhDw6BBNT9teCvGaukiAYB5gMiEn4z5XxjGw4asU=';
	...
	var chatConfig = {
		...
		azureTTS: {
			// uncomments respective files in index.html
